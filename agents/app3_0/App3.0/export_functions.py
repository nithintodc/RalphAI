...
def _build_dd_financial_breakdown(dd_data_path, start_date, end_date, excluded_dates,
    ...
    try:
        ...
        store_col_name = get_dd_financial_store_id_column(filtered)

        if not store_col_name or store_col_name not in filtered.columns:
            return None
...
def _get_dd_store_col_name(df):
    ...
    return get_dd_financial_store_id_column(df)
