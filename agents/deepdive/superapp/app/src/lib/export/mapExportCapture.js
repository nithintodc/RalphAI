 ...
 */
import { buildStoreMetricsLookup } from '../utils/storeIdMatch.js';

export const MAP_METRICS_STORAGE_KEY = 'superapp_store_metrics';

function resolveMapApiParams() {
  const exportApiBase =
    ...
    || (import.meta.env.VITE_GOOGLE_SHEETS_EXPORT_URL
      ...
      : '');
  if (exportApiBase) return { api: exportApiBase };
  return { apiPort: import.meta.env.VITE_LOCAL_EXPORT_API_PORT || '8765' };
}
