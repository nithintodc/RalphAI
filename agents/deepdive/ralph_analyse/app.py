...
:root {
    ...
    --text: #101828; --muted: #667085; --primary: #E8792B;
}
...
.kpi-up{color:#047857}.kpi-down{color:#B42318}.kpi-flat{color:var(--muted)}
...
.stButton>button[data-testid="baseButton-primary"]{
    background:linear-gradient(135deg,#E8792B,#D4682A)!important;color:#fff!important;
...
.stButton>button[data-testid="baseButton-primary"]:hover{
    background:linear-gradient(135deg,#D4682A,#C05A22)!important;transform:translateY(-1px);
...
.step-active .step-badge{background:#E8792B;color:#fff}
.step-done .step-badge{background:#047857;color:#fff}
.step-pending .step-badge{background:#E5E7EB;color:#667085}
