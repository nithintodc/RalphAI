...
def _build_day_slot(df: pd.DataFrame, date_col: str, time_col: str, subtotal_col: str, payout_col: str, order_col: str) -> pd.DataFrame:
    ...
    from shared.slot_metrics import aggregate_per_store, build_order_records, per_store_to_day_slot_frame
    ...
    for rows in per_store.values():
        for row in rows:
            ...
            bucket = merged.setdefault(key, {"sales": 0.0, "payouts": 0.0, "orders": 0})
