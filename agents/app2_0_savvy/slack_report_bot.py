...
def generate_app2_report_excel(
    ...
    *,
    ...
    try:
        ...
        dd_table1, dd_table2 = (
            table_generation.get_platform_store_tables(dd_sales_df, dd_payouts_df, dd_orders_df, "selected_stores_DoorDash")
            if not dd_sales_df.empty
            else (None, None)
        )
        ue_table1, ue_table2 = (
            table_generation.get_platform_store_tables(ue_sales_df, ue_payouts_df, ue_orders_df, "selected_stores_UberEats")
        ...
        promotion_table, sponsored_table, corporate_todc_table, _campaign_metrics_table = marketing_analysis.create_corporate_vs_todc_table(
            excluded_dates=excluded_dates,
            pre_start_date=pre_start,
            pre_end_date=pre_end,
            post_start_date=post_start,
