...
def create_browser_use_browser(
    ...
    *,
    ...
    Connection priority:
      1. Multilogin profile (USE_MULTILOGIN / MULTILOGIN_CDP_URL)
      2. LOCAL_BROWSER_CDP_URL — remote headless Chrome (GCP VM, etc.)
      3. Local Chrome executable (macOS)
      4. Default browser-use browser
    """
    ...
    mlx_cdp = resolve_multilogin_cdp_url(doordash_email)
    if mlx_cdp:
