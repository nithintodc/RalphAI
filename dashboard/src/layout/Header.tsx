...
const titles: Record<string, string> = {
  "/": "Dashboard",
  "/agents": "Agents",
  "/agents/marketingreco": "MarketingReco",
  "/agents/campaign-review": "Campaign Review",
  "/agents/offers": "Offers",
  "/agents/ads": "Ads",
  "/agents/data-run": "Data Run",
  "/agents/strategist": "Strategist",
  "/agents/health-check": "Health Check",
  "/agents/campaign-killer": "Campaign Killer",
